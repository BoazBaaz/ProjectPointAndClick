...
namespace GameEngine
{
    public class Room1 : GameObject
    {
        ...
        public void Updater()
        {
            ...
            core.CreateButton(Items.itemNames.Bread, Items.itemKinds.material, core.m_TestBread, 410, 290, 70, 40);
            core.CreateButton(Items.itemNames.Matches, Items.itemKinds.material, core.m_TestMatches, 230, 380, 50, 50);
        }
