...
namespace GameEngine
{
    ...
    public class GameEngine : IDisposable
    {
        ...
        private void CreateWindow()
        {
            ...
            m_RenderForm.StartPosition = FormStartPosition.CenterScreen;
    ...
    public class Button : GameObject
    {
        ...
        private Vector2f m_BorderCornerRadius = new Vector2f(20.0f, 0f);
        ...
        private void Initialize(ButtonCallbackNoArgs callback, string text, Rectanglef rectangle)
        {
            ...
            m_DefaultFont = new Font("Algerian", 20.0f);
